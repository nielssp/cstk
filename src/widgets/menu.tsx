...
import { apply, Component, createElement, Deref, Show, Unwrap } from "../component";
import { Context } from "../context";
import { For } from "../list";
import { bind, Property, ref } from "../property";
...
export function MenuBar(props: {
    menu: Menu|Property<Menu>,
}, context: Context) {
    const menu = bind(props.menu);
    const list = document.createElement('ul');
